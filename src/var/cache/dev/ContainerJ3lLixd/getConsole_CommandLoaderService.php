...
class getConsole_CommandLoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'Overblog\\GraphQLBundle\\Command\\CompileCommand' => ['services', 'Overblog\\GraphQLBundle\\Command\\CompileCommand', 'getCompileCommandService', true],
            'Overblog\\GraphQLBundle\\Command\\DebugCommand' => ['services', 'Overblog\\GraphQLBundle\\Command\\DebugCommand', 'getDebugCommandService', true],
            'Overblog\\GraphQLBundle\\Command\\GraphQLDumpSchemaCommand' => ['services', 'Overblog\\GraphQLBundle\\Command\\GraphQLDumpSchemaCommand', 'getGraphQLDumpSchemaCommandService', true],
            'Overblog\\GraphQLBundle\\Command\\ValidateCommand' => ['services', 'Overblog\\GraphQLBundle\\Command\\ValidateCommand', 'getValidateCommandService', true],
            ...
            'Overblog\\GraphQLBundle\\Command\\CompileCommand' => 'Overblog\\GraphQLBundle\\Command\\CompileCommand',
            'Overblog\\GraphQLBundle\\Command\\DebugCommand' => 'Overblog\\GraphQLBundle\\Command\\DebugCommand',
            'Overblog\\GraphQLBundle\\Command\\GraphQLDumpSchemaCommand' => 'Overblog\\GraphQLBundle\\Command\\GraphQLDumpSchemaCommand',
            'Overblog\\GraphQLBundle\\Command\\ValidateCommand' => 'Overblog\\GraphQLBundle\\Command\\ValidateCommand',
