 ...
 */
class getOverblogGraphql_Definition_IntTypeService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'overblog_graphql.definition.int_type' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/webonyx/graphql-php/src/Type/Definition/IntType.php';

        return $container->services['overblog_graphql.definition.int_type'] = \GraphQL\Type\Definition\Type::int();
    }
}
