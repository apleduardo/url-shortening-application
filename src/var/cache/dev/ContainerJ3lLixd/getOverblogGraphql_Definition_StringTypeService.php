 ...
 */
class getOverblogGraphql_Definition_StringTypeService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'overblog_graphql.definition.string_type' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/webonyx/graphql-php/src/Type/Definition/StringType.php';

        return $container->services['overblog_graphql.definition.string_type'] = \GraphQL\Type\Definition\Type::string();
    }
}
