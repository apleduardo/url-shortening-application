...
class getOverblogGraphql_ResolverResolverService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addSolution('App\\GraphQL\\Resolver\\ShortnnerUrlResolver', [0 => [0 => $container, 1 => 'get'], 1 => [0 => 'App\\GraphQL\\Resolver\\ShortnnerUrlResolver']], [], ['id' => 'App\\GraphQL\\Resolver\\ShortnnerUrlResolver', 'aliases' => [], 'method' => '__invoke']);
        $instance->addSolution('App\\GraphQL\\Resolver\\ShortnnerUrlResolver::resolve', [0 => [0 => $container, 1 => 'get'], 1 => [0 => 'App\\GraphQL\\Resolver\\ShortnnerUrlResolver']], [0 => 'ShortnnerUrl'], ['id' => 'App\\GraphQL\\Resolver\\ShortnnerUrlResolver', 'aliases' => [0 => 'ShortnnerUrl'], 'method' => 'resolve']);
