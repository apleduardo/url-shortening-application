...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\ShortnerController' => 'getShortnerControllerService',
            'App\\GraphQL\\Mutation\\ShortnerUrlCreateMutation' => 'getShortnerUrlCreateMutationService',
            'App\\GraphQL\\Resolver\\ShortnerUrlResolver' => 'getShortnerUrlResolverService',
            ...
            'Overblog\\GraphQLBundle\\__DEFINITIONS__\\MutationType' => 'getMutationTypeService',
            ...
            'Overblog\\GraphQLBundle\\__DEFINITIONS__\\ShortnerUrlInputType' => 'getShortnerUrlInputTypeService',
            'Overblog\\GraphQLBundle\\__DEFINITIONS__\\ShortnerUrlType' => 'getShortnerUrlTypeService',
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'base_url': $value = $this->getEnv('resolve:APP_BASE_URL_SHORTNER'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'overblog_graphql_types.config' => [
                'Mutation' => [
                    ...
                    'config' => [
                        'fields' => [
                            'createShortner' => [
                                'type' => 'ShortnerUrl',
                                'resolve' => '@=mutation(\'create_shortner\', [args])',
                                'args' => [
                                    'input' => [
                                        'type' => 'ShortnerUrlInput',
                                    ],
                                ],
                            ],
                        ],
                ...
                'ShortnerUrlInput' => [
                    'type' => 'input-object',
                    'class_name' => 'ShortnerUrlInputType',
                    'inherits' => [
